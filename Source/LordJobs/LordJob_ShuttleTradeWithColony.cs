...
namespace Spaceports.LordJobs
{
    public class LordJob_ShuttleTradeWithColony : LordJob_TradeWithColony
    {
        ...
        public override StateGraph CreateGraph()
        {
            ...
            transition9.AddTrigger(new Trigger_TickCondition(() => LordToil_ExitMapAndEscortCarriers.IsAnyDefendingPosition(lord.ownedPawns) && !GenHostility.AnyHostileActiveThreatTo_NewTemp(base.Map, faction, countDormantPawnsAsHostile: true), 60));
